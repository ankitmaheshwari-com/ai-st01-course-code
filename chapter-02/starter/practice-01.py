...
# LAYOUT: SIDEBAR
# -----------------------------
# st.sidebar lets you place elements on the side of the page.
# Useful for inputs, navigation, filters, or extra information.
# Everything using st.sidebar.* appears in the left sidebar.
...
# Then place UI elements inside each column.
